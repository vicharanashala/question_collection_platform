  ...
  return (
    <div className="flex flex-col h-full">
      <header className="flex items-center justify-between px-6 py-4 border-b border-border">
        <div>
          <h1 className="text-xl font-semibold">Distributor Dashboard</h1>
      ...
      <div className="flex-1 overflow-auto px-6 py-4 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{stats?.indianStatesTotal ?? indianStates.length}</div>
              <p className="text-xs text-muted-foreground mt-1">All Indian states/UTs covered</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">Total question-state rows</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{stats?.byState.filter((b) => b.count > 0).length ?? 0}</div>
              <p className="text-xs text-muted-foreground mt-1">of {indianStates.length} states have at least one distribution</p>
            </CardContent>
          </Card>
        </div>
